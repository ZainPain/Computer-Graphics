...
NETID : ZPAYA2
CS418 MP2.1
OnKeyDown, Handlekeyup,Handlekeydown, and Handlekeys are the functions added for mp2B
*/
...
// controls the speed at which the plane moves
var speed = 0.005;
var Stop = 0.00;
// Create the normal
...
function handleKeys() {
        ...
        if (currentlyPressedKeys[70]) {
            // F to go slowdown
            speed -= 0.0001;
        } else if (currentlyPressedKeys[82]) {
            // R to go fast
            speed += 0.0001;
        } 
...
function setupTerrainBuffers() {
    ...
    /**************************************/
    var numT = terrainFromIteration(gridN, -5,5,-5,5, vTerrain, fTerrain, nTerrain);
...
function draw() { 
    ...
    {
      uploadLightsToShader([0,1,1],[1.0,0.0,2.0],[1.0,0.5,0.0],[0.0,0.0,0.0]);
      drawTerrain();
    }
    ...
    if(document.getElementById("wireframe").checked){
      uploadLightsToShader([0,1,1],[1.0,1.0,1.0],[2.0,2.0,0.0],[0.0,0.0,0.0]);
      drawTerrainEdges();
    }
    mvPopMatrix();
...
function onKeyDown(event)
{
    ...
    if(event.keyCode =="81"){
        ...
        //create the quat
        quat.setAxisAngle(eyeQuatUD, axisToRot, degToRad(0.25))
    ...
    //create the quat
        quat.setAxisAngle(eyeQuatUD, axisToRot2, degToRad(0.25))
    ...
    //create the quat
        quat.setAxisAngle(eyeQuatUD, axisToRot3, degToRad(1.25))
